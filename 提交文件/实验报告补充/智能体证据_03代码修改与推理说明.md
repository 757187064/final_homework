...
- `src_severstal_data.py` — 数据读取、CSV 聚合
- `src_severstal_infer.py` — 推理与提交文件生成
- `src_severstal_models.py` — 模型构建
- `src_severstal_dataset.py` — PyTorch Dataset 定义
- `configs_baseline.yaml`、`configs_debug.yaml`、`configs_full_pipeline.yaml`、`configs_ablation_no_augmentation.yaml`、`configs_ablation_no_scheduler.yaml` — 实验配置
...
- `configs_baseline.yaml`
- `configs_debug.yaml`
- `configs_full_pipeline.yaml`
- `configs_ablation_no_augmentation.yaml`
- `configs_ablation_no_scheduler.yaml`
