...
def run_experiment(config_path, name):
    ...
    cmd = [sys.executable, "scripts_train.py", "--config", config_path]
...
def main():
    experiments = [
        ("configs_ablation_resnet50.yaml", "ResNet50"),
        ("configs_optimization_loss_dice_heavy.yaml", "Loss_Dice_Heavy"),
    ]
