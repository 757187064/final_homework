...
set EXPERIMENTS[0]=configs/baseline.yaml
set EXPERIMENTS[1]=configs/ablations/no_augmentation.yaml
set EXPERIMENTS[2]=configs/ablations/aug_very_strong.yaml
set EXPERIMENTS[3]=configs/ablations/efficientnet_b3.yaml
set EXPERIMENTS[4]=configs/ablations/loss_dice_heavy.yaml
...
for /L %%i in (0,1,4) do (
    ...
    python scripts/train.py --config !EXPERIMENTS[%%i]!
