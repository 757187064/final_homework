...
# 实验配置
EXPERIMENTS = [
    ('Baseline', 'configs/baseline.yaml', 'outputs/baseline_unet_resnet34'),
    ('No_Augmentation', 'configs/ablations/no_augmentation.yaml', 'outputs/ablation_no_augmentation'),
    ('Strong_Augmentation', 'configs/ablations/aug_very_strong.yaml', 'outputs/ablation_strong_augmentation'),
    ('EfficientNet_B3', 'configs/ablations/efficientnet_b3.yaml', 'outputs/ablation_efficientnet_b3'),
    ('Loss_Dice_Heavy', 'configs/ablations/loss_dice_heavy.yaml', 'outputs/ablation_loss_dice_heavy'),
]
